...
def validation_udacity_data(batchsize, path='/home/fabi/sdc/data/udacity-dataset-2-2/clean_dataset_2.bag'):
    bag = rosbag.Bag(path)
...
def udacity_data_generator(batchsize, path='/home/fabi/sdc/data/2016-10-10/clean_dataset_3.bag', shift=None):
    cvbridge = CvBridge()
