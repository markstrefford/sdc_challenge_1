...
class DataParser:
    ...
    def callback1(self,data):
        try:
            cv_image = self.center_bridge.imgmsg_to_cv2(data, "bgr8")
            self.center_camera_container.put(cv_image)
    ...
    def callback2(self,data):
        try:
            cv_image = self.left_bridge.imgmsg_to_cv2(data, "bgr8")
            self.left_camera_container.put(cv_image)
        except CvBridgeError as e:
            print(e)
    ...
    def callback3(self,data):
        try:
            cv_image = self.right_bridge.imgmsg_to_cv2(data, "bgr8")
            
            self.right_camera_container.put(cv_image)
        except CvBridgeError as e:
            print(e)  

        #cv2.imshow("Image window 3", cv_image)
        #cv2.waitKey(3)
